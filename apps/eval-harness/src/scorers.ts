import type { RunOutcome, ScoreResult, Scorer } from './types.js';
 ...
 */
export const commitDisciplineScorer: Scorer = (outcome: RunOutcome): ScoreResult => {
...
export const tddScorer =
  (cfg: { readonly targetSymbol: string }): Scorer =>
