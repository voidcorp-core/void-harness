...
| skill | named in |
| --- | --- |
| `void-autopilot` | `packages/cli/scripts/conformance-autopilot.mjs`<br>`packages/cli/src/commands/autopilot-usage.ts`<br>`packages/cli/src/lib/autopilot/judgment-comment.ts`<br>`packages/cli/src/lib/autopilot/review-signature-fixtures.ts`<br>`packages/cli/src/lib/autopilot/review-signature.ts`<br>`scripts/independent-review-check.mjs` |
