...
- [ ] Skill tests in `test/accessibility-first/` cover: raw onClick detection, missing label detection, contrast violation detection, missing dual-viewport screenshot
