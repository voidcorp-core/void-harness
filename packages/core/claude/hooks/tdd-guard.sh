...
# Materializes the Iron Law of voidcorp:tdd (strict mode blocks, souple warns,
...
# Config: .voidcorp/config.json (paths.business, paths.spikes, modes.tdd).
...
# Mode resolution: file-header marker > .voidcorp/config.json > "auto"
