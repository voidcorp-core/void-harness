...
1. Each skill invocation logs to `.void/activations.jsonl` (local, never shipped).
...
- Product strategy or roadmap decisions (use `plan-ceo-review`; a raw idea's demand pressure-test lives in `brainstorming`)
