...
5. **Visual pass** — for visual/interaction judgment on the live screenshots, compose `harness:ui-review` (register classification, squint test, interaction-state coverage, technical audit). This skill drives the browser; `ui-review` supplies the craft bar.
