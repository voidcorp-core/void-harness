...
function readTddConfig(root) {
  let config = {};
  try {
    config = record2(JSON.parse(readFileSync5(join4(root, ".void/config.json"), "utf8"))) ?? {};
  } catch {
  }
...
import { existsSync as existsSync6, mkdirSync as mkdirSync2, readFileSync as readFileSync9, readdirSync as readdirSync2, renameSync as renameSync2, writeFileSync as writeFileSync2 } from "node:fs";
import { dirname as dirname5, join as join9 } from "node:path";

import { lstatSync as lstatSync2, readFileSync as readFileSync8, readdirSync, statSync as statSync4 } from "node:fs";
