// packages/hook-runner/src/enforcement/governing-skill.ts
var GOVERNING_SKILL = {
...
// packages/hook-runner/src/enforcement/runner.ts
import {
  closeSync,
...
// packages/hook-runner/src/rules/boundary-direction.ts
import { existsSync, readFileSync } from "node:fs";
import { dirname, join, resolve } from "node:path";

// packages/hook-runner/src/rules/verdict.ts
...
// packages/hook-runner/src/rules/source-helpers.ts
...
// packages/hook-runner/src/rules/control-character.ts
...
// packages/hook-runner/src/rules/design-slop.ts
...
// packages/hook-runner/src/rules/no-any.ts
...
// packages/hook-runner/src/rules/no-as-cast.ts
...
// packages/hook-runner/src/rules/project-config.ts
...
// packages/hook-runner/src/rules/no-console.ts
...
// packages/hook-runner/src/rules/no-focused-test.ts
...
// packages/hook-runner/src/rules/no-null.ts
...
// packages/hook-runner/src/rules/test-name.ts
...
// packages/hook-runner/src/enforcement/shell-writes.ts
...
// packages/hook-runner/src/enforcement/normalize.ts
...
// packages/hook-runner/src/freshness/cache.ts
...
// packages/hook-runner/src/freshness/compare.ts
...
// packages/hook-runner/src/freshness/registry.ts
...
// packages/hook-runner/src/freshness/npmrc.ts
...
// packages/hook-runner/src/freshness/notice.ts
...
// packages/hook-runner/src/invocation.ts
...
// packages/hook-runner/src/retired-skills.ts
var RETIRED_SKILLS = {
...
// packages/hook-runner/src/lifecycle/checkpoint-audit.ts
var DAY_MS = 864e5;
var STALE_DAYS = 7;
...
// packages/hook-runner/src/lifecycle/context.ts
...
// packages/hook-runner/src/lifecycle/context-continuity-executor.ts
...
// packages/hook-runner/src/lifecycle/executor-shared.ts
import {
  accessSync,
  constants,
...
// packages/hook-runner/src/lifecycle/context-executor.ts
...
// packages/hook-runner/src/lifecycle/format-executor.ts
import { spawnSync } from "node:child_process";

// packages/hook-runner/src/lifecycle/format.ts
import {
...
// packages/hook-runner/src/lifecycle/large-change-executor.ts
import { spawnSync as spawnSync2 } from "node:child_process";

// packages/hook-runner/src/lifecycle/large-change.ts
...
// packages/hook-runner/src/lifecycle/session-close-intent.ts
...
// packages/hook-runner/src/lifecycle/trim-executor.ts
...
// packages/hook-runner/src/lifecycle/trim.ts
...
// packages/hook-runner/src/lifecycle/typecheck-executor.ts
import { existsSync as existsSync7 } from "node:fs";
import { join as join15 } from "node:path";
import { spawnSync as spawnSync3 } from "node:child_process";

// packages/hook-runner/src/lifecycle/typecheck.ts
import {
  dirname as dirname5,
