...
export interface ProgramSummary {
  readonly status: ProgramDescriptor['status'];
...
export interface ResumeBundleInput {
  ...
  readonly program: ProgramDescriptor | undefined;
...
function summarizeProgram(descriptor: ProgramDescriptor): ProgramSummary {
  return {
