...
@media(max-width:480px){header,main,footer{padding:16px}header h1{font-size:24px;line-height:1.15;margin:8px 0}header p{font-size:14px;line-height:1.4;margin:8px 0}.installation{padding:8px 12px}.filter-grid{grid-template-columns:repeat(auto-fit,minmax(min(100%,10em),1fr))}.filter-footer{gap:12px;flex-wrap:wrap}.filter-footer p{margin:6px 0;flex:1 1 10em}.filter-footer button{flex-shrink:0}.summary{align-items:flex-start;flex-direction:column;gap:0}.summary p{margin:4px 0}.entry-heading{align-items:flex-start}.invocation{flex-wrap:wrap}.invocation code{flex-basis:65%}.invocation button{margin-left:auto}}
