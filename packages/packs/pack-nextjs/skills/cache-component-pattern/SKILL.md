...
- `void-react:client-vs-server-component` — only Server Components participate in Cache Components.
- `void-server:server-action` — actions call `revalidateTag` / `revalidatePath` after mutations.
